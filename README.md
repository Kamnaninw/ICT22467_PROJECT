...
ระบบนี้ใช้แนวคิดการเชื่อมโยงข้อมูลสินค้าเข้ากับ RFID Tag, Zone และ Shelf เพื่อให้สามารถตรวจสอบได้ว่าสินค้าแต่ละรายการอยู่ที่ตำแหน่งใด มีจำนวนคงเหลือเท่าใด และมีสถานะเป็นอย่างไร เช่น In-Stock, Moving หรือ Shipped นอกจากนี้ยังสามารถบันทึกรายการรับเข้าและเบิกออก พร้อมเก็บประวัติการทำรายการย้อนหลังได้
...
- **Shelf** เป็นตำแหน่งย่อยภายใน Zone
...
หากระบบของคุณใช้บัญชีอื่น ให้เปลี่ยนข้อมูลส่วนนี้ตามข้อมูลจริง
